...
export const serviceDetailPages = [
  ...
  },
  {
    ...
    metaDescription:
      'Tag Easy builds AI automation that captures leads, qualifies intent, updates your CRM, and follows up over WhatsApp and email — with human approval built in.',
    h1: 'AI Automation for Marketing & Operations',
    tagline: 'Systems that capture, qualify, and follow up automatically.',
    intro:
      'Most businesses lose leads to slow follow-up and drown in repetitive work. We design connected systems that capture every lead, qualify intent with AI, route it into your CRM, and follow up instantly — while keeping you in control with clear approval points.',
    audience: 'Teams losing leads to slow follow-up or buried in repetitive marketing, sales, and ops tasks.',
    problems: [
      'Leads going cold before anyone responds',
      'Manual data entry across forms, sheets, and CRM',
      'No single view of marketing and sales activity',
    ...
    cta: {
      ...
      text: 'Book a free automation audit and we will map your fastest, highest-impact workflow.',
    },
  },
  {
    slug: 'paid-ads',
